...
$(document).ready(function () {
    ...
    $("#products").on("click", () => {
      ...
      if ($(".header__menu-big--products").hasClass("header__menu-big--active")) {
        ...
        $(".header__menu-big--products").slideToggle("slow");
        $(".header__menu-big--products").addClass("header__menu-big--active");
      }
    ...
    $("#services").on("click", () => {
      ...
      if ($(".header__menu-big--services").hasClass("header__menu-big--active")) {
        ...
        $(".header__menu-big--services").slideToggle("slow");
        $(".header__menu-big--services").addClass("header__menu-big--active");
      }
    ...
    $("#search").on("click", (e) => {
        ...
        $(".header__input-find").css("display", "block");
        $(".header__cross").css("display", "block");
    });
    $(".header__cross").on("click", (e) => {
        e.preventDefault();
        $(".header__input-wrapper").removeClass(
        ...
        $(".header__input-find").css("display", "none");
        $(".header__cross").css("display", "none");
...
(function ($, window, document, undefined) {
    ...
    var methods = {
        ...
        getIndex: function (e) {
            ...
            index =
                minRating &&
                minRating <= this.settings.totalStars &&
                index < minRating
                    ? minRating - 1
                    : index;
            return index;
            ...
            $.each(
                ...
                function (index, star) {
                    ...
                    leftClass = rightClass =
                        index <= endIndex ? stateClass : "empty";

                    // has another half rating, add half star
                    leftClass =
                        index - endIndex === 0.5 ? stateClass : leftClass;

                    $polygonLeft.attr(
                        "class",
                        "svg-" + leftClass + "-" + this._uid
                    );
                    $polygonRight.attr(
                        "class",
                        "svg-" + rightClass + "-" + this._uid
                    );

                    // get color for level
                    var ratedColorsIndex =
                        endIndex >= 0 ? Math.ceil(endIndex) : 0;
