...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#products").on("click", function () {
    ...
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(".header__menu-big--auth").hasClass("header__menu-big--active")) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".header__menu-big--auth").slideToggle("slow");
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".header__menu-big--auth").removeClass("header__menu-big--active");
    }
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#ui").on("click", function () {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(".header__menu-big--services").hasClass("header__menu-big--active")) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".header__menu-big--services").slideToggle("slow");
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".header__menu-big--services").removeClass("header__menu-big--active");
    }
    ...
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(".header__menu-big--auth").hasClass("header__menu-big--active")) {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".header__menu-big--auth").slideToggle("slow");
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".header__menu-big--auth").addClass("header__menu-big--active");
    }
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#log").on("click", function () {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(".header__menu-big--services").hasClass("header__menu-big--active")) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".header__menu-big--services").slideToggle("slow");
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(".header__menu-big--services").removeClass("header__menu-big--active");
    }
